...
function run() {
  ...
  let phdrs = ["Search something!", "Type anything here to search!", "This is a cool search engine", "Why aren't you typing stuff here?", "Try clicking the info button on search results!", "This took me a day to make", "Do you like the search engine?", "No Lenard, I'm not showing you where the easter eggs are located.", "Let your Light Shine!", "Unlike Google, this doesn't track you!", "You can share links to searches!", "I worked hard to style this!", "Good luck to all the candidates running for Student Council!"]
  setInterval(() => {
